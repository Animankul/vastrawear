...
export default function Home() {
  return (
    <>
      <Head>
        <title>VastraWear</title>
        <meta name="description" content="VastraWear.com - Wear the Clothes" />
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the Clothes with vastrawear.com</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want? What you want? So why not wear the Clothes</p>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want? What you want? So why not wear the Clothes</p>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear whatever you want? What you want? So why not wear the Clothes</p>
    </div>
